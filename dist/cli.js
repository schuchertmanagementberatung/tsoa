...
exports.validateSwaggerConfig = function (config) { return __awaiter(void 0, void 0, void 0, function () {
...
if (!module.parent) {
    yargs
        ...
        .command('swagger-and-routes', 'Generate swagger and routes', {
        basePath: basePathArgs,
        configuration: configurationArgs,
        host: hostArgs,
        json: jsonArgs,
...
function swaggerSpecGenerator(args) {
    return __awaiter(this, void 0, void 0, function () {
        var config, compilerOptions, swaggerConfig, routesConfig, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                ...
                case 1:
                    ...
                    return [4 /*yield*/, exports.validateSwaggerConfig(config.swagger)];
                case 2:
                    swaggerConfig = _a.sent();
                    return [4 /*yield*/, validateRoutesConfig(config.routes)];
                case 3:
                    routesConfig = _a.sent();
                    return [4 /*yield*/, generate_swagger_spec_1.generateSwaggerSpec(swaggerConfig, routesConfig, compilerOptions, config.ignore)];
                case 4:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 5:
...
function routeGenerator(args) {
    return __awaiter(this, void 0, void 0, function () {
        var config, compilerOptions, routesConfig, swaggerConfig, err_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                ...
                case 3:
                    swaggerConfig = _a.sent();
                    return [4 /*yield*/, generate_routes_1.generateRoutes(routesConfig, swaggerConfig, compilerOptions, config.ignore)];
                case 4:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 5:
...
function generateSwaggerAndRoutes(args) {
    return __awaiter(this, void 0, void 0, function () {
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, Promise.all([
                            generate_routes_1.generateRoutes(routesConfig, swaggerConfig, compilerOptions, config.ignore, metadata),
                            generate_swagger_spec_1.generateSwaggerSpec(swaggerConfig, routesConfig, compilerOptions, config.ignore, metadata),
                        ])];
...
exports.generateSwaggerAndRoutes = generateSwaggerAndRoutes;

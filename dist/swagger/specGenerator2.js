    ...
    SpecGenerator2.prototype.buildDefinitions = function () {
        ...
        Object.keys(this.metadata.referenceTypeMap).map(function (typeName) {
            ...
            if (referenceType.dataType === 'refObject') {
                ...
                definitions[referenceType.refName] = __assign(__assign(__assign({}, swaggerType), { default: referenceType.default || swaggerType.default, example: referenceType.example, description: referenceType.description }), validators);
            }
            else {

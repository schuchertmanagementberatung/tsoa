...
var SpecGenerator3 = /** @class */ (function (_super) {
    ...
    SpecGenerator3.prototype.buildParameter = function (source) {
        ...
        parameter.schema.format = parameterType.format || undefined;
    ...
    SpecGenerator3.prototype.getSwaggerType = function (type) {
        if (type.dataType === 'union') {
            return this.getSwaggerTypeForUnionType(type);
        }
        if (type.dataType === 'intersection') {

...
var ParameterGenerator = /** @class */ (function() {
  ...
  ParameterGenerator.prototype.Generate = function() {
    var _this = this;
    var decoratorName = decoratorUtils_1.getDecoratorName(this.parameter, function(identifier) {
  ...
  ParameterGenerator.prototype.getBodyPropParameter = function(parameter) {
    ...
    return {
      ...
      in: 'body-prop',
      name:
        decoratorUtils_1.getDecoratorTextValue(this.parameter, function(ident) {
  ...
  ParameterGenerator.prototype.supportPathDataType = function(parameterType) {
    ...
    return supportedPathDataTypes.find(function(t) {

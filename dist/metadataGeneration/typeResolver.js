...
var TypeResolver = /** @class */ (function () {
    ...
    TypeResolver.prototype.resolve = function () {
        ...
        if (ts.isMappedTypeNode(this.typeNode) && this.referencer) {
            ...
            var properties = tsProperties.filter(isNotIgnored).map(function (property) {
    ...
    TypeResolver.prototype.getTypeAliasReference = function (declaration, name, referencer) {
        ...
        return __assign({ dataType: 'refAlias', default: jsDocUtils_1.getJSDocComment(declaration, 'default'), description: this.getNodeDescription(declaration), refName: this.getRefTypeName(name), type: new TypeResolver(declaration.type, this.current, declaration, this.context, this.referencer || referencer).resolve(), validators: validatorUtils_1.getPropertyValidators(declaration) || {} }, (example && { example: example }));
    };

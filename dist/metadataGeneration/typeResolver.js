...
var TypeResolver = /** @class */ (function() {
  ...
  TypeResolver.prototype.resolve = function() {
    ...
    if (ts.isMappedTypeNode(this.typeNode) && this.referencer) {
      ...
      var tsProperties = this.current.typeChecker.getPropertiesOfType(type).map(function(symbol) {
    ...
    if (ts.isConditionalTypeNode(this.typeNode) && this.referencer) {
      ...
      if (type.aliasSymbol) {
        ...
        return this.handleCachingAndCircularReferences(name_2, function() {
          return _this.getModelReference(declaration_2, name_2);
        });
      } else {
        try {
  ...
  TypeResolver.prototype.getModelReference = function(modelType, name) {
    ...
    var referenceType = __assign(
      { additionalProperties: additionalProperties, dataType: 'refObject', description: this.getNodeDescription(modelType), properties: inheritedProperties, refName: this.getRefTypeName(name) },
      example && { example: example },
    );

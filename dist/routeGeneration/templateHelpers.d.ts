...
export declare function ValidateParam(property: TsoaRoute.PropertySchema, value: any, generatedModels: TsoaRoute.Models, name: string | undefined, fieldErrors: FieldErrors, parent: string | undefined, swaggerConfig: SwaggerConfigRelatedToRoutes): any;
export declare class ValidationService {
    private readonly models;
    constructor(models: TsoaRoute.Models);
    ValidateParam(property: TsoaRoute.PropertySchema, rawValue: any, name: string | undefined, fieldErrors: FieldErrors, parent: string | undefined, minimalSwaggerConfig: SwaggerConfigRelatedToRoutes): any;
    validateNestedObjectLiteral(name: string, value: any, fieldErrors: FieldErrors, swaggerConfig: SwaggerConfigRelatedToRoutes, nestedProperties: {
    ...
    validateEnum(name: string, value: any, fieldErrors: FieldErrors, members?: Array<string | number | boolean>, parent?: string): any;
    ...
    validateArray(name: string, value: any[], fieldErrors: FieldErrors, swaggerConfig: SwaggerConfigRelatedToRoutes, schema?: TsoaRoute.PropertySchema, validators?: ArrayValidator, parent?: string): any[] | undefined;
    validateBuffer(name: string, value: string): Buffer;
    validateUnion(name: string, value: any, fieldErrors: FieldErrors, swaggerConfig: SwaggerConfigRelatedToRoutes, subSchemas: TsoaRoute.PropertySchema[] | undefined, parent?: string): any;
    validateIntersection(name: string, value: any, fieldErrors: FieldErrors, swaggerConfig: SwaggerConfigRelatedToRoutes, subSchemas: TsoaRoute.PropertySchema[] | undefined, parent?: string): any;
    private resolveAdditionalPropSetting;
    private toModelLike;

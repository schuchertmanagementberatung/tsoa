...
export declare function ValidateParam(
...
export declare class ValidationService {
  ...
  validateModel(input: { name: string; value: any; modelDefinition: TsoaRoute.ModelSchema; fieldErrors: FieldErrors; parent?: string; minimalSwaggerConfig: SwaggerConfigRelatedToRoutes }): any;
}

...
export declare class ValidationService {
    ...
    ValidateParam(property: TsoaRoute.PropertySchema, value: any, name: string | undefined, fieldErrors: FieldErrors, parent: string | undefined, minimalSwaggerConfig: SwaggerConfigRelatedToRoutes): any;

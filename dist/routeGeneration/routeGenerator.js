...
var RouteGenerator = /** @class */ (function() {
  function RouteGenerator(metadata, options, minimalSwaggerConfig) {
  ...
  RouteGenerator.prototype.buildContent = function(middlewareTemplate, pathTransformer) {
    ...
    var additionalPropsHelper = function(additionalProperties) {
      ...
      } else if (_this.minimalSwaggerConfig.noImplicitAdditionalProperties === 'silently-remove-extras') {
        return JSON.stringify(false);
      } else if (_this.minimalSwaggerConfig.noImplicitAdditionalProperties === 'throw-on-extras') {
        return JSON.stringify(false);
      } else if (_this.minimalSwaggerConfig.noImplicitAdditionalProperties === undefined) {
        // Since Swagger defaults to allowing additional properties, then that will be our default
        return JSON.stringify(true);
      } else if (_this.minimalSwaggerConfig.noImplicitAdditionalProperties === true) {
        deprecations_1.warnAdditionalPropertiesDeprecation(_this.minimalSwaggerConfig.noImplicitAdditionalProperties);
        return JSON.stringify(false);
      } else if (_this.minimalSwaggerConfig.noImplicitAdditionalProperties === false) {
        deprecations_1.warnAdditionalPropertiesDeprecation(_this.minimalSwaggerConfig.noImplicitAdditionalProperties);
        return JSON.stringify(true);
      } else {
        return assertNever_1.assertNever(_this.minimalSwaggerConfig.noImplicitAdditionalProperties);
      }
    };
  ...
  RouteGenerator.prototype.buildModels = function() {
    ...
    Object.keys(this.metadata.referenceTypeMap).forEach(function(name) {
      ...
      if (referenceType.dataType === 'refEnum') {
        ...
        } else if (_this.minimalSwaggerConfig.noImplicitAdditionalProperties) {
